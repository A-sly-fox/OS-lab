...
//test priority
struct task_info task2_13 = {(ptr_t)&priority_task1, USER_PROCESS};
struct task_info task2_14 = {(ptr_t)&priority_task2, USER_PROCESS};
struct task_info task2_15 = {(ptr_t)&priority_task3, USER_PROCESS};
struct task_info *priority_tasks[16] = {&task2_13, &task2_14, &task2_15};
int num_priority_tasks = 3;
